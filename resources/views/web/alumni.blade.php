            ...
            <div class="row">
                <div class="col-12">
                    <div class="bg-dark p-4 text-center rounded-3">
                        <h1 class="text-white m-0">Daftar Alumni</h1>
                        <!-- Breadcrumb -->
                        <div class="d-flex justify-content-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-dark breadcrumb-dots mb-0">
                                    <li class="breadcrumb-item active" aria-current="page">Hamidu & Sawahud</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <table id="example" class="table dt-responsive table-dark-gray align-middle mb-0 table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="border-0">Kordinator</th>
                                            <th scope="col" class="border-0 rounded-end">Angkatan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($alumni as $alm)                                            
                                            <tr>
                                                ...
                                                <td>{{ $alm->angkatan !== null ? $alm->angkatan : '-' }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
