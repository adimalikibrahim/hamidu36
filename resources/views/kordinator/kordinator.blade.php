                            ...
                            @foreach ($kordinator as $kor)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/anggota-kordinator/{{ $kor->id_kordinator }}" class="btn btn-sm btn-info-soft me-1 mb-1 mb-md-0">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="kordinator" placeholder="Enter Nama Kordinator"
                                    required>
                            </div>
                            <div class="col-12 mb-3">
