            ...
            <div class="container">
                        ...
                        <ul class="navbar-nav navbar-nav-scroll mx-auto">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="demoMenu">
                                    <li> <a class="dropdown-item" href="index">Home Default</a></li>
                                    <li> <a class="dropdown-item" href="index-2">Home Education</a></li>
                                    ...
                                    <li> <a class="dropdown-item" href="index-9">Home School <span
                                                class="badge bg-success ms-2 smaller">New</span></a></li>
                                    <li> <a class="dropdown-item" href="index-10">Home Abroad <span
                                                class="badge bg-success ms-2 smaller">New</span></a></li>
                                    <li>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                                    ...
                                    <li class="dropdown-submenu dropend">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                            <li> <a class="dropdown-item" href="course-categories">Course Categories <span
                                                        class="badge bg-success ms-2 smaller">New</span></a></li>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li> <a class="dropdown-item" href="course-grid">Course Grid Classic</a></li>
                                            <li> <a class="dropdown-item" href="course-grid-2">Course Grid Minimal</a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li> <a class="dropdown-item" href="course-list">Course List Classic</a></li>
                                            <li> <a class="dropdown-item" href="course-list-2">Course List Minimal</a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li> <a class="dropdown-item" href="course-detail">Course Detail Classic</a>
                                            </li>
                                            <li> <a class="dropdown-item" href="course-detail-min">Course Detail
                                                    Minimal</a></li>
                                            <li> <a class="dropdown-item" href="course-detail-adv">Course Detail
                                                    Advance</a></li>
                                            <li> <a class="dropdown-item" href="course-video-player">Course Full Screen
                                                    Video</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li> <a class="dropdown-item" href="abroad-single">Abroad Single <span
                                                class="badge bg-success ms-2 smaller">New</span></a></li>
                                    ...
                                    <li class="dropdown-submenu dropend">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                            ...
                                            <li> <a class="dropdown-item" href="shop-product-detail">Product detail</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="dropdown-submenu dropend">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                            ...
                                            <li> <a class="dropdown-item" href="help-center-detail">Help Center Single</a>
                                            </li>
                                        </ul>
                                    </li>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="accounntMenu">
                                    ...
                                    <li class="dropdown-submenu dropend">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                            ...
                                            <li> <a class="dropdown-item" href="instructor-manage-course"><i
                                            ...
                                            <li> <a class="dropdown-item" href="instructor-create-course"><i
                                                    ...
                                                    Course</a> </li>
                                            <li> <a class="dropdown-item" href="course-added"><i
                                                        class="bi bi-file-check-fill fa-fw me-1"></i>Course Added</a> </li>
                                            <li> <a class="dropdown-item" href="instructor-quiz"><i
                                                        class="bi bi-question-diamond fa-fw me-1"></i>Quiz <span
                                                        class="badge bg-success ms-2 smaller">New</span></a> </li>
                                            <li> <a class="dropdown-item" href="instructor-earning"><i
                                                        class="fas fa-chart-line fa-fw me-1"></i>Earnings</a> </li>
                                            <li> <a class="dropdown-item" href="instructor-studentlist"><i
                                            ...
                                            <li> <a class="dropdown-item" href="instructor-review"><i
                                                        class="bi bi-star-fill fa-fw me-1"></i>Reviews</a> </li>
                                            <li> <a class="dropdown-item" href="instructor-payout"><i
                                    ...
                                    <li class="dropdown-submenu dropend">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                            <li> <a class="dropdown-item" href="student-dashboard"><i
                                                        class="bi bi-grid-fill fa-fw me-1"></i>Dashboard</a> </li>
                                            <li> <a class="dropdown-item" href="student-subscription"><i
                                                        class="bi bi-card-checklist fa-fw me-1"></i>My Subscriptions</a>
                                            </li>
                                            <li> <a class="dropdown-item" href="student-course-list"><i
                                                        class="bi bi-basket-fill fa-fw me-1"></i>Courses</a> </li>
                                            <li> <a class="dropdown-item" href="student-course-resume"><i
                                                        class="far fa-fw fa-file-alt me-1"></i>Course Resume <span
                                                        class="badge bg-success ms-2 smaller">New</span></a> </li>
                                            <li> <a class="dropdown-item" href="student-quiz"><i
                                                        class="bi bi-question-diamond fa-fw me-1"></i>Quiz <span
                                                        class="badge bg-success ms-2 smaller">New</span></a> </li>
                                            <li> <a class="dropdown-item" href="student-payment-info"><i
                                                        class="bi bi-credit-card-2-front-fill fa-fw me-1"></i>Payment
                                                    Info</a> </li>
                                            <li> <a class="dropdown-item" href="student-bookmark"><i
                                    ...
                                    <li> <a class="dropdown-item" href="instructor-edit-profile"><i
                                                class="fas fa-fw fa-edit me-1"></i>Edit Profile</a> </li>
                                    <li> <a class="dropdown-item" href="instructor-setting"><i
                                                class="fas fa-fw fa-cog me-1"></i>Settings</a> </li>
                                    <li> <a class="dropdown-item" href="instructor-delete-account"><i
                            ...
                            <li class="nav-item"><a class="nav-link" href="docs/alerts">Components</a></li>
                ...
                <div class="dropdown ms-1 ms-lg-0">
                    @if (Route::has('login'))
                        ...
                        @else
                            {{-- <a class="btn btn-round btn-primary-shadow btn-sm" href="{{ route('login') }}"><i class="bi bi-power"></i></a> --}}
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <!-- Image -->
                        <img src="assets/images/element/error404-01.svg" class="h-200px h-md-400px mb-4"
                            alt="">
                        <!-- Title -->
                        ...
                        <!-- Button -->
                        {{-- <a href="index" class="btn btn-primary mb-0">Take me to Homepage</a> --}}
                    </div>
                </div>
            </div>
        </section>
                                    ...
                                    <div class="dropup mt-0 text-center text-sm-end">
                                        ...
                                        <ul class="dropdown-menu min-w-auto" aria-labelledby="languageSwitcher">
                                            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                                        src="assets/images/flags/uk.svg" alt="">English</a>
                                            </li>
                                            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                                        src="assets/images/flags/gr.svg" alt="">German </a>
                                            </li>
                                            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
