				...
				<div class="col-12 col-lg-6 m-auto">
					<div class="row my-5">
						<div class="col-sm-10 col-xl-8 m-auto">
							...
							<!-- Form START -->
							<form id="formAuthentication" class="mb-3" action="login" method="POST"> @csrf
								<!-- Email -->
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
                                        ...
                                        id="email" placeholder="E-mail" id="exampleInputEmail1" autofocus required autocomplete="email">
									</div>
                                    @error('email')
								...
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="password" id="password" class="form-control border-0 bg-light rounded-end ps-1 @error('password') is-invalid @enderror"
