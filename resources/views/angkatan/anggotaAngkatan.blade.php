        ...
        <div class="{{$alumni->count() !== 0 ? 'col-md-6' : 'col-md-12' }} col-sm-12">
            <div class="card bg-transparent border">
                <div class="card-header bg-light border-bottom d-sm-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Angkatan {{$angkatan->angkatan}}</h5>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center position-relative">
                                                ...
                                                <div class="mb-0 ms-2">
                                                    <h6 class="mb-0">
                                                        <a href="#"
                                                        class="stretched-link">{{ $angar->nama !== null ? $angar->nama : '-' }}</a>
                                                    </h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>{{ $angar->kec !== null ? $angar->kec : '-' }}</td>
                                        <td>
                                            <form action="/anggota-angkatan/{{$angar->id_alumni}}" method="post"> @csrf @method('delete')
                                ...
                                <tbody>
                                    @foreach ($alumni as $al)
                                        <tr>
                                            ...
                                            <td>{{ $al->kec }}</td>
                                            <td>
                                                <form action="/anggota-angkatan/{{$id_ang}}" method="post"> @csrf
